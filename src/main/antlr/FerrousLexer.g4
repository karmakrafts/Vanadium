...
M_INSIDE_PC_KW_WHEN:        PC_KW_WHEN          -> type(PC_KW_WHEN);
...
M_INSIDE_PC_KW_END:         PC_KW_END           -> type(PC_KW_END);
...
M_INSIDE_STR_INTERP:        STR_INTERP          -> type(STR_INTERP);
...
M_INSIDE_KW_ALLOC:          KW_ALLOC            -> type(KW_ALLOC);
...
M_INSIDE_KW_FREE:           KW_FREE             -> type(KW_FREE);
...
// ---------- Nested rules for recursive parsing
M_RAW_STRING_DOUBLE_QUOTE:  DOUBLE_QUOTE    -> popMode, type(DOUBLE_QUOTE);
M_RAW_STRING_INTERP:        STR_INTERP      -> pushMode(M_INTERP_STRING), type(STR_INTERP);
M_RAW_STRING_TEXT:          ~('"' | '$')+ | '$';
...
M_STRING_INTERP:        STR_INTERP      -> pushMode(M_INTERP_STRING), type(STR_INTERP);
M_STRING_TEXT:          ~('\\' | '"' | '$')+ | '$';
